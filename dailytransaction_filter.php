<?php 
 ...
 // $results = $DB->read($query);
    ...
    $result_filter_report_buyer = $report->get_report_by_date_buyer($name, $date);
     $result_filter_report_seller = $report->get_report_by_date_seller($name, $date);
    
    
    if($result_filter_report_buyer || $result_filter_report_seller){
   ...
   $name = $_GET['name'];
            ...
            echo "<script type='text/javascript'>alert('There have no data within that date ! please select date again'); ";
            echo "window.location= 'dailytransaction.php?id=$name' ";
            echo "</script> ";
            die;
    }
...
.styled-table tbody tr.active-row {
  ...
  <th>Category</th>
                         ...
                         foreach ($result_filter_report_buyer as $ROW) {
...
echo"</table>";
                      ...
                      <?php
                      if($result_filter_report_seller)
                     {
  ...
  <th>Item Description</th>
    <th>Category</th>
                         ...
                         foreach ($result_filter_report_seller as $ROW) {
