...
if(isset($_SERVER['HTTP_REFERER']) && !strstr($_SERVER['HTTP_REFERER'], "delete_for_market.php"))
{
...
if($_SERVER['REQUEST_METHOD'] === 'POST')
{
   ...
   $item->delete_for_marketpost($_POST['itemid']);
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Delete market post</title>
    </head>
