 ...
 if($_SERVER['REQUEST_METHOD'] == "POST")
 {
    ...
    $DB = new Database();
     ...
     if($amount > $walletamount){
                 ...
                 echo "<script type='text/javascript'>alert('Your balance is not enough to cash out ! please enter sufficient amount again'); ";
                 // echo "window.location= '$_SESSION[return_to]'";
                 echo "window.location= 'cashout.php'";
                 echo"</script> ";
                 ...
                 echo "<script type='text/javascript'>alert('Your have successfully cash out !'); ";
                 // echo "window.location= '$_SESSION[return_to]'";
                 echo "window.location= 'cashout.php'";
                 echo"</script> ";
     }
     ...
     echo  $walletamount;
              ...
              <br><br><br>     
               ...
               <form method="post"  class="w3-opacity">
                    ...
                    <input type="number"  min="1" step="any"  name="topupamount" id="topupamount" required="required" placeholder="Cash out amount">  <br><br>  
                 
                    <label for="paymentmethod">Choose a cash out gateway:</label>
...
<select name="methods" id="methods">
  ...
  <option value="Touch n go e-wallet">Touch n go e-wallet</option>
                    ...
                    <input class="w3-button w3-theme" type="submit" value="Cash out" style="cursor: pointer; float: right;">
                    <br>  
               </form>
              <br><br><br>
          ...
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <br><br>
                ...
                Do you want to top up ? Click here <a href="topup.php" class="w3-button w3-theme-d1 w3-margin-bottom">Top Up</a>  
              <br><br><br>
