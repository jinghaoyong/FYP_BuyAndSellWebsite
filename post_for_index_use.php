              ...
              ?>
                <br><br>
                             ...
                             ?>
                                ...
                                <?php
                                 ...
                                 if($post->i_own_post($ROW['postid'], $_SESSION['taruc_studentid'])){
                                     ...
                                     echo "
                                 <a href='report_post.php?id=$ROW[postid]' class='w3-button w3-theme-d2 w3-margin-bottom'  >
                                     Report$reports
                                 </a>";
                                 }
                                 ?>
                             ...
                             <?php
                              ...
                              if($ROW['has_image']){
                                 echo "<a href='image_view.php?id=$ROW[postid]' style='text-decoration: none; float:right;' class='w3-button w3-theme-d1 w3-margin-bottom'>";
